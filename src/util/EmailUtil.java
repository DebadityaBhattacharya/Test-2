...
public class EmailUtil {
	...
	public static void main(String[] args) throws Exception {
        ...
        try {
        	...
        	Document doc = docBuilder.parse (new File(System.getProperty("user.dir")+"/screenshots/test_reportv2.html"));
...
//        	    System.out.println("value of text variable is "+(i)+text[i]);
      ...
      //  if (failedItems > 20) {
        	// toEmail = "jaspreet.oberoi@abpdigital.in,rohit.negi@abpdigital.in,debaditya.bhattacharya@abpdigital.in,abhinav.verma@abpdigital.in,vibhor.maurya@abpdigital.in ";
      //  } else {shashank.mehta@abpdigital.in
         	 toEmail = "debaditya.bhattacharya@abpdigital.in";   	
       // 		}
...
*/      
	...
	//	System.out.println(CONFIG.getProperty("testSiteURL"));
       ...
       // EmailUtil.sendAttachmentEmail(session, toEmail," TR: "+ "Total number of articles in ABP are - " + test_sitemap.base.flag +"Total number of articles in Ebela are " + test_sitemap.base.flag +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
	    EmailUtil.sendAttachmentEmail(session, toEmail," TR: "+ "T2ONLINE|TRENDING STORIES Test" +" "+ Arrays.toString(text), "Sir, Check your Automation report with attached logs.");
